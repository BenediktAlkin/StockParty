...
class TestSimulation(unittest.TestCase):
    ...
    def test_simple(self):
        start_time = "14:00"
        points = [
            Point(start_time=start_time, time="14:00", value=1.5, now=datetime(2022, 1, 1, 14, 5)),
            Point(start_time=start_time, time="14:15", value=2.0, now=datetime(2022, 1, 1, 14, 5)),
        ]
